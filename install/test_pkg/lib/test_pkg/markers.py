...
class MarkerProperties:
    ...
    def _set_MarkerStyle(
        ...
        self.marker.scale.x = float(marker_scaleX)
        self.marker.scale.y = float(marker_scaleY)
        self.marker.scale.z = 0.0 if marker_scaleZ is None else float(marker_scaleZ)
        self.marker.color.a = float(marker_transparency)
